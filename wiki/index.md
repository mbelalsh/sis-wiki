...
- [[Concept-Bottleneck-Models]] — Koh et al. 2020 (ICML); architectural pattern for concept-level interventions; mechanism for verifying concept-closure invariance in CBM-CTPC | sis_relevance: high | sources: 1
...
- [[Analytic-Covariance-Propagation]] — Wright et al. 2024 (AISTATS); Theorem 1 closed-form covariance through nonlinear activations + Algorithm 1 layer-by-layer propagation; technical machinery for Analytic-Σ-CTPC | sis_relevance: high | sources: 1
...
- [[CTPC-Design-Rationale]] — Synthesis page combining PhyArch DP + CTPC + Barbiero interpretability framing; Part I D1–D7 (decisions made), Part II Q1–Q8 (deferred to PhyArch-CTPC), Part III (PhyArch as first practical instantiation of actionable interpretability — 3-of-4 enforced, concept closure + information invariance now both have *concrete verifiable plans* via [[CBM-CTPC-Composition]] and [[Analytic-Sigma-CTPC-Composition]]); two-year arc: Year 1 CBM verification, Year 2 Analytic-Σ verification | sis_relevance: critical | sources: 5
